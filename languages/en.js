...
// support.js
supportDescription: "Support server",
supportTitle: "Support Server",
supportServerLink: "discord.gg/enzlewy",
githubLink: "https://facebook.com/gwwennn",
replitLink: "zalo.me/0817893363",
youtubeLink: "<@1262464227348582492>",
...
supportImageURL: '',
supportDescriptionTitle: "Join our Discord server",
followUsOn: "Follow",
discord: "Discord",
github: "Facebook",
replit: "Zalo",
...
beautifulReplyText: '{user} trông thật xinh đẹp!',
beautifulError: 'Đã xảy ra lỗi khi thực hiện lệnh này!',
beautifulNoMention: 'Bạn phải tag người dùng để bot lấy ảnh đại diện của họ!',
// choose.js
chooseDescription: 'Pick ngẫu nhiên một mục từ các tùy chọn được cung cấp',
chooseOptionsDescription: 'Các tùy chọn được phân tách bằng dấu phẩy',
chooseTitle: 'Random',
chooseOptionsText: '**Lựa chọn:**',
chooseChosenText: '**Bố mày chọn:**',
// darkness.js
...
// friendship.js
friendshipDescription: 'chỉ số tình bạn',
friendshipUserDescription: 'The user to rate friendship with',
friendshipTitle: 'Friendship Rating',
friendshipWith: 'và',
friendshipRating: 'chỉ số tình bạn của nhau là',
friendshipFooter: 'Friendship rating is just for fun!',
friendshipMentionError: 'Vui lòng tag 2 users để đánh giá tình bạn.',
// gay.js
...
//random num.js
randomnumCommandDescription: 'Random Numbers',
randomnumError: 'Vui lòng cung cấp số hợp lệ cho giá trị tối thiểu và tối đa.',
randomnumTitle: 'Random Number',
randomnumDescription: 'Số ngẫu nhiên từ **{min}** đến **{max}** là: **{randomNumber}**',
// rate.js
...
// ship.js
shipCommandDescription: 'Love',
shipUser1Description: 'First user to ship',
shipUser2Description: 'Second user to ship',
shipEmbedTitle: 'Check Love',
shipPercentageFieldName: 'Love Percentage',
shipMessageFieldName: 'Message',
shipLowMessage: 'chà có vẻ 2 bạn không hợp nhau lắm đâu 😊',
shipMediumMessage: 'một tình yêu chớm nở 🍀',
shipHighMessage: 'hai bạn rất hợp với nhau 🌸 ',
shipVeryHighMessage: 'chà tình yêu của hai bạn thật tuyệt vời ✨',
shipFooterText: 'This ship rate is just for fun 😃',
shipReplyContent: '{user1} và {user2} có {shipPercentage}% tình yêu 💕',
shipErrorMessage: 'Đã xảy ra lỗi khi thực hiện lệnh này!',
shipMentionErrorMessage: 'Vui lòng tag 2 người dùng cần check love.',
//wordassoc.js
...
// addrole.js
addRoleCommandDescription: 'Add role cho member',
addRoleTargetDescription: 'member cần add role',
addRoleRoleDescription: 'Role cần add',
addRoleNoPermission: 'Bạn không có quyền sử dụng lệnh này.',
addRoleAlreadyHasRole: '${target.tag} đã có role ${role.name} rồi.',
addRoleSuccess: 'Đã add role ${role.name} cho ${target.tag}.',
addRoleOnlySlashCommand: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/addrole` để add role cho member.',
addRoleAlert: 'Alert!',
// addrole.js
addRoleCommandDescription: 'Add role cho member',
addRoleTargetDescription: 'member cần add role',
...
addRoleAlert: 'Alert!',
// ban.js
banCommandDescription: 'Ban member',
banTargetDescription: 'member cần ban',
banNoPermission: 'Bạn không có quyền sử dụng lệnh này.',
banCannotBan: 'Không có quyền để ban ${target.tag} ra khỏi server!',
banSuccess: '${target.tag} has been banned.',
banOnlySlashCommand: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/ban` để ban member.',
banAlert: 'Alert!',
// dm.js
dmCommandDescription: 'DMS member trong server',
dmTargetDescription: 'member cần DMS',
dmReasonDescription: 'tin nhắn cần gửi',
dmReceivedTitle: 'Tin Nhắn DMS',
dmReceivedDescription: '${sender} đã gửi cho bạn 1 tin nhắn trực tiếp từ ${interaction.guild.name}: ${reason}',
dmOnlySlashCommand: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/dm` để gửi tin nhắn DMS cho member.',
dmAlert: 'Alert!',
// kick.js
kickCommandDescription: 'Kick member',
kickTargetDescription: 'member cần kick',
kickNoPermission: 'Bạn không có quyền sử dụng lệnh này.',
kickCannotKick: 'Không có quyền để kick ${target.tag} ra khỏi server!',
kickSuccess: '${target.tag} has been kicked.',
kickOnlySlashCommand: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/kick` để kick member.',
kickAlert: 'Alert!',
// lockchannel.js
lockChannelCommandDescription: 'Khóa kênh',
lockChannelNoPermission: 'Bạn không có quyền sử dụng lệnh này.',
lockChannelSuccess: 'Đã khóa kênh thành công.',
// mute.js
muteCommandDescription: 'Mute member',
muteTargetDescription: ' member cần mute',
muteDurationDescription: 'Thời gian mute tính bằng phút',
muteNoPermission: 'Bạn không có quyền sử dụng lệnh này.',
muteCannotMute: 'Không có quyền để mute ${target.tag} trong server này!',
muteSuccess: '${target.tag} đã bị mute trong ${duration} phút.',
muteOnlySlashCommand: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/mute` để mute member.',
muteAlert: 'Alert!',
// purge.js
purgeCommandDescription: 'Xóa tin nhắn được chỉ định ra khỏi kênh',
...
purgeNoDeletePermission: 'Bạn không có quyền để xóa tin nhắn kênh này.',
purgeMessagesOld: 'Không thể xóa tin nhắn hơn 14 ngày.',
...
removeroleSuccess: 'Đã xóa role ${role.name} khỏi ${target.tag}.',
removeroleOnlySlashCommand: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/removerole` để xóa role member.',
// removeslowmode.js
...
// setnickname.js
setnicknameCommandDescription: 'đặt biệt danh cho member',
setnicknameNoPermission: 'Bạn không có quyền sử dụng lệnh này.',
setnicknameSuccess: ' {target} đã được đặt biệt danh thành {nickname}.',
setnicknameNoNickname: 'Vui lòng cung cấp biệt danh.',
setnicknameMemberNotFound: 'Không tìm thấy member này trong server',
setnicknameCannotChange: 'Không thể thay đổi biệt danh của {target}.',
setnicknameFailed: 'Không thể thay đổi biệt danh, vui lòng thử lại sau.',
setnicknamePrefixError: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/setnickname` để thay đổi biệt danh member.',
// setslowmode.js
...
// unmute.js
unmuteDescription: 'Unmutes member trong server',
unmuteNoPermission: 'Bạn không có quyền sử dụng lệnh này.',
unmuteNotMuted: '{target} không bị muted!',
unmuteSuccess: '{target} has been unmuted.',
unmutealertTitle: 'Alert!',
unmutealertDescription: '- Lệnh này chỉ có thể được sử dụng thông qua lệnh slash!\n- Vui lòng sử dụng `/unmute` để unmute member.',
// warn.js
warnDescription: 'Cảnh báo member trong server',
warnNoPermissions: '**Bạn không có quyền sử dụng lệnh này.**',
warnSuccess: '**{sender} đã cảnh báo {target} vì: {reason}**',
warnDMTitle: 'Đã được cảnh báo!',
warnDMDescription: 'bạn đã nhận được cảnh báo từ {sender} trong server {guildName} vì: {reason}',
// createembed.js
