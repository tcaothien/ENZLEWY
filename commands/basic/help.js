        ...
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            const createSlashCommandPages = () => {
                ...
                pages.push({
                    ...
                    description: ` Chào mừng đến với 𝙀𝙣𝙯𝙡𝙚𝙬𝙮! Bot này cung cấp nhiều lệnh khác nhau để nâng cao trải nghiệm máy chủ của bạn. Dưới đây là các danh mục và số lượng lệnh có sẵn trong mỗi danh mục.`,
                    commands: [
